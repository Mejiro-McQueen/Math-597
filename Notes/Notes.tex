...
\begin{proof}
	...
	Using a generalized form of the inclusion exclsuion principle, we can count the nuber of ordered pairs that aren't in a subset containing elements that are not coprime to some $p\in X_l$.
...
\begin{thm}
	...
	\end{defn}
	Example: 
	$\gcd_1(128,192,1280)=64$
	$\gcd_2(128,192,1280)=8$
	$\gcd_3(128,192,1280)=4$
	$\gcd_4(128,192,1280)=2$
	$\gcd_5(128,192,1280)=2$
	$\gcd_6(128,192,1280)=2$
	$\gcd_7(128,192,1280)=2$
	$\gcd_7(128,192,1280)=1$
